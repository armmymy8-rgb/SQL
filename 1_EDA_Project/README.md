# Exploratory Data Analyst with SQL:Job Market Analysis
![Project 1 Overview](image.png)
...
1. [`01_top_demand_skill.sql`](/1_EDA%20Project/01_top_demand_skill.sql) – demand analysis with multi-table joins
2. [`02_top_paying_skill.sql`](/1_EDA%20Project/02_top_paying_skill.sql) – salary analysis with aggregations
3. [`03_optimal_skills.sql`](/1_EDA%20Project/03_optimal_skills.sql)  – combined demand/salary optimization query
...
![Project 1 Data Warehouse](/Lesson/1_2_Data_Warehouse.png)
...
## Analysis Overview
### Query Structure
1. **[Top Demanded Skills](/1_EDA%20Project/01_top_demand_skill.sql)** – Identifies the 10 most in-demand skills for remote data engineer positions
2. **[Top Paying Skills](/1_EDA%20Project/02_top_paying_skill.sql)** – Analyzes the 25 highest-paying skills with salary and demand metrics
3. **[Optimal Skills](/1_EDA%20Project/03_optimal_skills.sql)** – Calculates an optimal score using natural log of demand combined with median salary to identify the most valuable skills to learn
